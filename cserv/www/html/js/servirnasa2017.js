...
function submitMonthlyAnalysisRequest()
{
    ...
    try
    {
        ...
        seasonal_start_date = "2018_01_01"; //single_climate_model_capabiliites.startDateTime; //"2017_05_01";
        seasonal_end_date = "2018_05_21"; //single_climate_model_capabiliites.endDateTime; //"2017_10_28";
    }
...
function submitMonthlyGEFSAnalysisRequest()
{
    ...
    data =
    {
        'custom_job_type':'MonthlyGEFSRainfallAnalysis',
        'seasonal_start_date':seasonal_start_date,
        'seasonal_end_date':seasonal_end_date
    };
    ...
    // Ajax section
    $.ajax({url: baserequesturl+'submitMonthlyGEFSRainfallAnalysisRequest/?callback=?',
    type: "get",
    data: data,
    dataType: "jsonp",
    jsonpCallback: 'successCallback',
...
var wheredatachanges;
function createChart(data)
{
	wheredatachanges = data;
    if (isFirefox)
        {
        $("#chartWindow").show();
    }
    ...
    try
    {
        var minMaxObj;
        try {
			console.log("*************** " + parameterTypes[parameterType]['uname'] + "*************************");
...
function get_NewMinMax_Adjust_Y_Axis_For_Thin_Ranges_SingleDataset(theData, theKeyName_ToData, theChart)
{
    ...
    { 
console.log("no min set");
        return null;
    }
    else
    {
		console.log("min being set");
