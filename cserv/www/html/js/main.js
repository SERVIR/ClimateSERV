...
function fullScreenWizard() {
    ...
    $('#fPage4 h2.title').text('Chart');
    $('#fPage4 h2.title').append('<span style="float:right; cursor:pointer;" onclick="closeWizard();">X</span>');
...
function normalWizard() {
    ...
    $('#fPage4 h2.title').text('Processing Results');
