...
# USGS Path
roothttp ='https://edcintl.cr.usgs.gov/downloads/sciweb1/shared/fews/web/asia/centralasia/afghanistan/dekadal/emodis/ndvi_c6/temporallysmoothedndvi/downloads/monthly/'

rootoutputdir = params.dataTypes[27]['inputDataLocation']
...
def getFileForYearAndMonth(yearToGet,monthToGet):
    ...
    url = roothttp+"afg"+filenum+'.zip'
    print url
    enddirectory =  rootoutputdir+str(yearToGet)+"/"
    endfilename = enddirectory+"afg"+filenum+'.zip'
    print endfilename
...
if __name__ == '__main__':
    print "Starting Downloading eMODIS Data for Afghanistan"
