...
#         ###Back to looking for work.
    ...
    def __preProcessIncomingRequest__(self, request):
        self.logger.info("QQQQQQQQQQQQQQQQQQQQQQQQQQQQQ")
...
# BillyZ Fixed this
                ...
                #self.logger.info('poly_area: ' + self.__poly_area__(geoutils.decodeGeoJSON(geometry)))
    ...
    def __unit_normal__(self, a, b, c):
