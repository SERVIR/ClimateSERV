...
@author: jeburks  Modified by Kris Stanton
'''
import CHIRPS.utils.processtools.dateIndexTools as dit

logToConsole = False 
serviringestroot = '''/home/jburks/code/pythonCode/serviringest/'''
...
dataTypes = (
             ...
             {'number':2,
              ...
              'size':[12847,14712],
              'directory':'/data/data/image/processed/eMODIS/ndvi-eastafrica/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation': '/data/data/image/input/emodis/eastafrica/',
              'data_category':'NDVI'
              },
             ...
             {'number':5,'name':'NDVI MODIS-South Africa',
              ...
              'size':[1600,1500],
              'directory':'/data/data/image/processed/eMODIS/ndvi-southafrica/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation':'/data/data/image/input/emodis/southafrica/',
              'data_category':'NDVI'
              },
