...
logToConsole = True
serviringestroot = '''/Users/kris/work/SERVIR/Code/Server/SERVIR/serviringest/'''
maskstorage = '''/Users/kris/temp/mask/'''
dbfilepath = '''/Users/kris/temp/servirchirps.db'''
newdbfilepath = '''/Users/kris/temp/servirchirps_bsd.db'''
capabilities_db_filepath = '''/Users/kris/temp/servirchirps_bsd_capabilities.db'''
requestLog_db_basepath = '''/Users/kris/temp/requestLog/''' # YYYY_MM_DD.db  # TODO!! ADD AUTO FOLDER CREATION FOR THIS FOLDER
zipFile_MediumTermStorage_Path = '''/Users/kris/temp/Zipfile_Storage/'''  # TODO!! ADD AUTO FOLDER CREATION FOR THIS FOLDER
zipFile_ScratchWorkspace_Path = '''/Users/kris/temp/Zipfile_Scratch/'''  # TODO!! ADD AUTO FOLDER CREATION FOR THIS FOLDER
logfilepath = '''/Users/kris/temp/logs/'''
workpath = '''/Users/kris/temp/chirpswork'''

shapefilepath = '''/Users/kris/Desktop/K_Tasks/CHIRPS_Work/CHIRPS/chirps/server_gis_mapfiles/''' # UPDATE: Some gis files have an 'operational' tag in their file name..  OLD NOTE: OPERATIONAL GIS FILES
#shapefilepath = '''/Users/kris/work/SERVIR/Data/GIS/mapfiles/''' # LOCAL COPY AND LOCAL PATHS for

resultsdir = '''/Users/kris/temp/results/'''

ageInDaysToPurgeData = 2

parameters = ([0,'max',"Max"],[1,'min',"Min"],[2,'median',"Median"],[3,'range',"Range"],[4,'sum',"Sum"],[5,'avg','Average'],[6,'download','Download'])
...
def get_ClimateChangeParam__directory(ensembleName,variableName):           
    return '/Users/kris/work/SERVIR/Data/Processed/climatechange/' + str(ensembleName) + '/' + str(variableName) + '/'
def get_ClimateChangeParam__inputDataLocation(ensembleName,variableName):  
    return '/Users/kris/work/SERVIR/Data/Image/climatechange/' + str(ensembleName) + '/' + str(variableName) + '/'
def get_ClimateChangeParam__modelOutputLocal_BaseFolder():
    return '/Users/kris/work/temp_NMME_Data/server_fs/data/nmme/GEOOUT/'
...
dataTypes = (
             {'number':0,
              ...
              'size':[7200,2000],
              'directory':'/Users/kris/work/SERVIR/Data/Processed/CHIRPS/',
              'fillValue':-9999.,
              'indexer': dit.DailyIndex(),
              'inputDataLocation':'/Users/kris/work/SERVIR/Code/Server/SERVIR/serviringest/',
             ...
             {'number':1,
              ...
              'size':[19271, 7874],
              'directory':'/Users/kris/work/SERVIR/Data/Processed/eMODIS/ndvi-westafrica/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation':'/Users/kris/work/SERVIR/Data/Image/eMODIS/westafrica/',
              'data_category':'NDVI'
              },
             ...
             {'number':2,
              ...
              'size':[12847,14712],
              'directory':'/Users/kris/work/SERVIR/Data/Processed/eMODIS/ndvi-eastafrica/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation': '/Users/kris/work/SERVIR/Data/Image/eMODIS/eastafrica/',
              'data_category':'NDVI'
             },
             ...
             {'number':3,
              ...
              'size':[23415, 7045],
              'directory':'/Users/kris/work/SERVIR/Data/Processed/eMODIS/ndvi-northafrica/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation':'/Users/kris/work/SERVIR/Data/Image/eMODIS/northafrica/',
              'data_category':'NDVI'
              },
             ...
             {'number':4,
              ...
              'size':[1600,1500],
              'directory':'/Users/kris/work/SERVIR/Data/Processed/eMODIS/ndvi-centralafrica/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation':'/Users/kris/work/SERVIR/Data/Image/eMODIS/centralafrica/',
              'data_category':'NDVI'
              },
             
             {'number':5,
              'name':'NDVI MODIS-South Africa',
              'description':'NDVI MODIS South Africa description',
              'size':[1600,1500],
              'directory':'/Users/kris/work/SERVIR/Data/Processed/eMODIS/ndvi-southafrica/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation': '/Users/kris/work/SERVIR/Data/Image/eMODIS/southafrica/',
              'data_category':'NDVI'
              },
            ...
            {   
             ...
             'directory'        :        get_ClimateChangeParam__directory('ens01', 'tref'),            # '/Users/kris/work/SERVIR/Data/Processed/climatechange/ens01/temperature/',
             'inputDataLocation'    :    get_ClimateChangeParam__inputDataLocation('ens01', 'tref'),    # '/Users/kris/work/SERVIR/Data/Image/climatechange/ens01/temperature/',
             'modelOutputLocal_BaseFolder':get_ClimateChangeParam__modelOutputLocal_BaseFolder(),       # '/Users/kris/work/temp_NMME_Data/server_fs/data/nmme/GEOOUT/',
            ...
            {   
             ...
             'modelOutputLocal_BaseFolder':get_ClimateChangeParam__modelOutputLocal_BaseFolder(),'size':get_ClimateChangeParam__size(),'fillValue':get_ClimateChangeParam__fillValue(),'indexer':get_ClimateChangeParam__indexer(),'number_Of_ForecastDays':get_ClimateChangeParam__number_Of_ForecastDays()              
            },
            ...
            {'number':26,
              ...
              'size':[3600,1800],
              'directory':'/Users/kris/work/SERVIR/Data/Processed/IMERG1Day/',
              'fillValue':-9999.,
              'indexer': dit.DynamicIndex("P1D"),
              'inputDataLocation': '/Users/kris/work/SERVIR/Data/Image/IMERG1Day/',
              'data_category':'IMERG'
            },
...
dataTypeInfo = ({'path':'/Users/kris/data/shapefiles','layer':'county'})
