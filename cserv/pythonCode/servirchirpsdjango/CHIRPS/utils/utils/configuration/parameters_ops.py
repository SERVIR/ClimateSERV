...
dataTypes = (
             ...
             {'number':2,
              ...
              'size':[12847,14712],
              'directory':'/data2/data2/image/processed/eMODIS/ndvi-eastafrica/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation': '/data2/data2/image/input/emodis/eastafrica/',
              'data_category':'NDVI'
              },
             ...
             {'number':5,'name':'NDVI MODIS-South Africa',
              ...
              'size':[19838,5666],
              'directory':'/data2/data2/image/processed/eMODIS/ndvi-southafrica/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation':'/data2/data2/image/input/emodis/southafrica/',
              'data_category':'NDVI'
              },
            ...
            { 'number':26,
              ...
              'size':[3600,1800],
              'directory':'/data2/data2/image/processed/IMERG1Day/',
              'fillValue':9999.,
              'indexer': dit.DynamicIndex("P1D"),
              'inputDataLocation':'/data2/data2/image/input/IMERG1Day/',
              'data_category':'IMERG'
            },
             ...
             {'number':27,'name':'NDVI MODIS-Afghanistan',
              ...
              'size':[6631,4144],
              'directory':'/data2/data2/image/processed/eMODIS/ndvi-afghanistan/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation':'/data2/data2/image/input/emodis/afghanistan/',
              'data_category':'NDVI'
              },
             ...
             {'number':28,'name':'NDVI MODIS-Asia',
              ...
              'size':[17406,13676],
              'directory':'/data2/data2/image/processed/eMODIS/ndvi-asia/np/',
              'fillValue':-9999.,
              'indexer': dit.EveryFiveDaysIndex(),
              'inputDataLocation':'/data2/data2/image/input/emodis/asia/',
              'data_category':'NDVI'
              },
             {'number':29,
              'name':'ESI','description':'Global ESI  Dataset ',
              'size':[7200,3000],
              'directory':'/data3/data3/image/processed/esi/',
              'fillValue':-9999.,
              'indexer': dit.DynamicIndex("P8D"), #dit.EveryEightDaysIndex(),
              'inputDataLocation':'/data/data/image/input/esi/',
              'data_category':'ESI'
              },
             {'number':30,
              'name':'SMAP','description':'SMAP  Dataset ',
              'size':[964,406],
              'directory':'/data2/data2/image/processed/SMAP/',
              'fillValue':-9999.,
              'indexer': dit.DailyIndex(),
              'inputDataLocation':'/data2/data2/image/input/smap/',
              'data_category':'SMAP'
              }, 
             {'number':31,
              'name':'Chirps-GEFS-Anom','description':'Global CHIRPS GEFS Anomalies Dataset ',
              'size':[7200,2000],
              'directory':'/data3/data3/image/processed/gefs_anom/',
              'fillValue':-9999.,
              'indexer': dit.DecadalIndex(),
              'inputDataLocation':'/data3/data3/image/input/gefs_anom/',
              'data_category':'CHIRPS'
              },
             {'number':32,
              'name':'Chirps-GEFS-Precip','description':'Global CHIRPS GEFS Precipitation Dataset ',
              'size':[7200,2000],
              'directory':'/data3/data3/image/processed/gefs_precip/',
              'fillValue':-9999.,
              'indexer': dit.DecadalIndex(),
              'inputDataLocation':'/data3/data3/image/input/gefs_precip/',
              'data_category':'CHIRPS'
              },
