...
# New USGS Path
roothttp ='http://edcintl.cr.usgs.gov/downloads/sciweb1/shared/fews/web/africa/east/pentadal/emodis/ndvi/temporallysmoothedndvi/downloads/monthly/'
...
if __name__ == '__main__':
    print "Starting Downloading eMODIS Data for East Africa"
