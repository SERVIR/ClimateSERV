...
# New USGS Path
roothttp ='http://edcintl.cr.usgs.gov/downloads/sciweb1/shared/fews/web/africa/southern/pentadal/emodis/ndvi/temporallysmoothedndvi/downloads/monthly/'
...
def should_rename_files(year_from_zip, list_of_filenames):
    for current_filename in list_of_filenames:
        if len(current_filename) == 9:
            part_to_compare = current_filename[3:5]
        else:
...
if __name__ == '__main__':
    print "Starting Downloading eMODIS Data for southern Africa"
