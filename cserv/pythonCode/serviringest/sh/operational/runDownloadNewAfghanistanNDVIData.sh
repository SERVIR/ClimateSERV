...
echo "Running East Africa NDVI Download from ${START_YEAR} to ${END_YEAR}"
$python CHIRPS/utils/ftp/eMODISAfghanistanDownloader.py ${START_YEAR} ${END_YEAR}
echo "Done running Chirps eMODISAfghanistanDownloader"
