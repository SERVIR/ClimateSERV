...
echo "Running Climate Change Scenario download for Ensemble, ${CLIMATE_MODEL_ENSEMBLE}, Variable, ${CLIMATE_MODEL_VARIABLE} and model run year month of ${CLIMATE_MODEL_RUN_YYYYMM} with option ${CLIMATE_MODEL_OPTION} set"
$python CHIRPS/utils/ftp/ftpClimateChangeScenarioDownloader.py ${CLIMATE_MODEL_ENSEMBLE} ${CLIMATE_MODEL_VARIABLE} ${CLIMATE_MODEL_RUN_YYYYMM} ${CLIMATE_MODEL_OPTION}
