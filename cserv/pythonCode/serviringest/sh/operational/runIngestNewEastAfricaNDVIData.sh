...
echo "Running eMODIS NDVI East Africa Ingest from ${START_YEAR} to ${END_YEAR}"
$python CHIRPS/utils/ingest/HDFIngestMODISNDVIDataEastAfrica.py ${START_YEAR} ${END_YEAR}
