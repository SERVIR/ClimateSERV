            ...
            if os.path.isfile(fileToProcess):
				...
				if os.path.isfile(fileToProcess):
					...
					if os.path.isfile(fileToProcess):
						...
						fileToProcess=fileToProcess.replace("04B","05A")          
...
# Notes
# Ingest whatever is in the folder and delete what was ingested..

# If params are passed in, than only try and ingest the yyyymmdd that was passed IN

# params  mode yyyymmdd
# Mode: ALL    /    Range YYYYMMDD


# Garbage

# Issue getting this to work right.. checking it out now
# /submitDataRequest/
#?callback=successCallback 
#&datatype=26
#&begintime=01%2F05%2F2016
#&endtime=01%2F09%2F2016
#&intervaltype=0
#&operationtype=5
#&dateType_Category=default
#&isZip_CurrentDataType=false
#&geometry=%7B%22type%22%3A%22Polygon%22%2C%22coordinates%22%3A%5B%5B%5B-108.28125000000003%2C45.791015625%5D%2C%5B-66.26953125000003%2C45.791015625%5D%2C%5B-68.90625000000003%2C29.091796875%5D%2C%5B-106.17187500000003%2C28.564453125%5D%2C%5B-108.28125000000003%2C45.791015625%5D%5D%5D%7D&_=1458596034511 HTTP/1.1" 200 57
#

# Capabilities Examples (empty DB and DB with stuff in it (from climate datasets examples)
#import CHIRPS.utils.db.bddbprocessing as bdp
#conn = bdp.BDDbConnector_Capabilities()
#currentValue = conn.get_Capabilities(25)
#currentValue
#'{"fillValue": -9999.0, "projection": "GEOGCS[\\"WGS 84\\",DATUM[\\"WGS_1984\\",SPHEROID[\\"WGS 84\\",6378137,298.257223563,AUTHORITY[\\"EPSG\\",\\"7030\\"]],AUTHORITY[\\"EPSG\\",\\"6326\\"]],PRIMEM[\\"Greenwich\\",0],UNIT[\\"degree\\",0.0174532925199433],AUTHORITY[\\"EPSG\\",\\"4326\\"]]", "startDateTime": "2015_09_01", "grid": [0.0, 0.5, 0.0, 90.0, 0.0, -0.5], "variable": "prcp", "variable_Label": "Precipitation", "size": [720, 360], "name": "Climate Change Scenario: ens10 Precipitation", "description": "Climate Change Scenario: ens10 Precipitation", "endDateTime": "2016_02_28", "date_FormatString_For_ForecastRange": "%Y_%m_%d", "data_category": "ClimateModel", "number_Of_ForecastDays": 180, "ensemble": "ens10"}'
#nonExistant = conn.get_Capabilities(26)
#nonExistant
#'{"Error":"No capabilities entry found for datatype 26."}'
#conn.close()


# Opening a TIF file (what to do about TFW??, do we need new code for that also?)
# filePath = "/Users/kris/work/SERVIR/Data/Image/IMERG1Day/3B-HHR-L.MS.MRG.3IMERG.20160105-S000000-E002959.0000.V03E.1day.tif"
